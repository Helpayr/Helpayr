...
class MessagePageService extends StatefulWidget {
  const MessagePageService({key});

  @override
  State<MessagePageService> createState() => _MessagePageState();
}

class _MessagePageState extends State<MessagePageService> {
...
class _StoryCardState extends State<_StoryCard> {
  @override
  Widget build(BuildContext context) {
    CollectionReference art = FirebaseFirestore.instance.collection("Users");
